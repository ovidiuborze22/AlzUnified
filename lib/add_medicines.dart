...
class AddMedicinesPage extends StatefulWidget {
  const AddMedicinesPage({Key? key}) : super(key: key);
...
class _AddMedicinesPageState extends State<AddMedicinesPage> {
  ...
  addMedicine() async {
    ...
    if(name.isNotEmpty && description.isNotEmpty && time.isNotEmpty && dosage.isNotEmpty){
      ...
      final uri1 = Uri.parse('${globals.url}addmedicine');
                    ...
                    children: [
                      ...
                      SizedBox(
                          ...
                          child: TextField(
                              ...
                              textInputAction: TextInputAction.next,
                              decoration: const InputDecoration(
                                labelText: "Pill (Dosage)",
                                labelStyle: TextStyle(
                                    color: Colors.black, fontSize: 13),
                                hintText: "Enter Pill (Dosage)",
                                hintStyle: TextStyle(fontSize: 13),
                                focusColor: Colors.black,
                                prefixIcon: Icon(
                                  Icons.key,
