  ...
  addActivity() async {
    ...
    if(dropDownValue == "Once (Today)"){
      ...
      formattedDate = formatter.format(now);
        ...
        var newDateTimeObj2 = DateFormat("yyyy-MM-dd HH:mm").parse("$formattedDate $time");
        epo = newDateTimeObj2.millisecondsSinceEpoch;
        print(epo);
    ...
    String ftime = "T$timestamp1";
      ...
      final uri1 = Uri.parse('${globals.url}addactivity');
