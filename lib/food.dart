...
class _FoodPageState extends State<FoodPage> {
  ...
  Future<void> connect() async {
    ...
    if (result == true) {
      ...
      final uri1 = Uri.parse('${globals.url}datetodayfood');
      ...
      persons = data1;
      final uri2 = Uri.parse('${globals.url}foodtilldate');
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (result == true) {
                ...
                final uri1 = Uri.parse('${globals.url}deletefood');
                final headers1 = {'Content-Type': 'application/json'};
                ...
                Visibility(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //   ),
                      // ),
                      // const Center(child: Padding(padding: EdgeInsets.only(top:20),child: Text("2/5 Food Taken"),),),
                      // const SizedBox(height: 30,),
                      Padding(
